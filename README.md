...
- **[pdfboss](https://github.com/4thel00z/pdfboss)** — From-scratch Rust PDF toolkit for Python: fast page rendering and text extraction via PyO3. Benchmarked faster than mainstream Python PDF libraries • Rust — latest release: [v1.0.0](https://github.com/4thel00z/pdfboss/releases/tag/v1.0.0) (2026-08-30)
