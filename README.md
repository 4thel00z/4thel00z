...
- **[pdfboss](https://github.com/4thel00z/pdfboss)** — From-scratch Rust PDF toolkit for Python: fast page rendering and text extraction via PyO3 — benchmarked faster than mainstream Python PDF libraries • Rust — latest release: [v0.8.0](https://github.com/4thel00z/pdfboss/releases/tag/v0.8.0) (2026-07-29)
