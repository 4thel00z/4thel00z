...
- **[turbofile](https://github.com/4thel00z/turbofile)** - Real async file I/O for Python: io_uring and POSIX AIO via a Rust core, behind an aiofiles-compatible asyncio API • Rust - latest release: [v0.1.1](https://github.com/4thel00z/turbofile/releases/tag/v0.1.1) (2026-09-01)
